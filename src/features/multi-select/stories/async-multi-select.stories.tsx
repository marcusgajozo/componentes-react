...
import { AsyncMultiSelect, type AsyncMultiSelectProps } from "../ui/index";
...
const meta = {
  title: "Components/AsyncMultiSelect",
...
} satisfies Meta<AsyncMultiSelectProps<{ data: Product[] }, Product>>;
